...
// Style navigation bar when scroll down
const appHeader = document.getElementById("ashade-header");
const appHeaderChild = document.querySelector(".ashade-header-inner");
const appLogo = document.querySelector(".ashade-header-inner .ashade-logo img");
...
function scrollFunction() {
  if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) {
    ...
    appHeader.style.color = "#fff !important";
  } else {
    appLogo.style.width = "100%";
    appHeaderChild.style.padding = "25px 50px";
...
// Hide little words in services page
